...
public class Room {
    ...
    public Room(String id, RoomType type, Vector3i size, List<ConnectionPoint> connections, List<RoomBlock> blocks, List<VariationArea> variations) {
    ...
    public static Room read(String id, ConfigurationSection s) {
        ...
        return new Room(id, type, size, cps, blocks, variations);
    }
}
